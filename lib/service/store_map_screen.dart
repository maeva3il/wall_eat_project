...
class _StoreMapScreenState extends State<StoreMapScreen> {
  ...
  Future<void> _loadMapData() async {
    final data = await LocationService.getMapDataFromStoreAddress(widget.storeAddress);
    if (data != null) {
      setState(() {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Impossible de charger les données de localisation')),
        );
      }
    }
  }
